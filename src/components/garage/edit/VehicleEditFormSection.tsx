...
export function VehicleEditFormSection({ form }: { form: UseFormReturn<EditFormInput> }) {
  const errors = form.formState.errors;
  return (
    <section className="space-y-4">
      <h3 className="text-sm font-semibold uppercase tracking-wide text-brand-fg-muted">Vozidlo</h3>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <FormField label="Aktuálny nájazd (km)" error={errors.current_mileage?.message} required>
          <Input
            type="number"
            inputMode="numeric"
            min={0}
